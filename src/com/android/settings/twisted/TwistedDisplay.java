...
public class TwistedDisplay extends SettingsPreferenceFragment implements
         Preference.OnPreferenceChangeListener {
         
    private static final String TAG = "TwistedDisplay";
   ...
   @Override
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mLcdDensityPreference != null) {
            ...
            int minimumDensity = defaultDensity - 8 * factor;
            int currentIndex = -1;
